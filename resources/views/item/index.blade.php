            ...
            <table id="itemTable" class="table align-items-center mb-0" style="width:100%">
              <thead>
                <tr>
                  ...
                  <th class="text-uppercase text-secondary font-weight-bolder opacity-7 ps-2">Unit</th>
        ...
        <div class="modal-body ">
          <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <select required id="item_category_id" type="text" name="item_category_id" class="form-control">
