            ...
            <table id="itemTable" class="table align-items-center mb-0" style="width:100%">
              <thead>
                <tr>
                  ...
                  <th class="text-uppercase text-secondary font-weight-bolder opacity-7 ps-2">Kode customer</th>
                  <th class="text-uppercase text-secondary font-weight-bolder opacity-7 ps-2">Nama customer</th>
