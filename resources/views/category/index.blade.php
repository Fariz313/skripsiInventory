            ...
            <table id="itemTable" class="table align-items-center mb-0" style="width:100%">
              <thead>
                <tr>
                  ...
                  <th class="text-uppercase text-secondary font-weight-bolder opacity-7 ps-2">Kode Kategori</th>
                  <th class="text-uppercase text-secondary font-weight-bolder opacity-7 ps-2">Nama Kategori</th>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body ">
          <div class="mb-3">
            ...
            <input required id="category_code" type="text" name="category_code" class="form-control" aria-describedby="emailHelp">
          </div>
            <div class="mb-3">
              <label class="form-label">Nama Kategori</label>
              <input required id="category_name" type="text" name="category_name" class="form-control" aria-describedby="emailHelp">
            </div>
        </div>
